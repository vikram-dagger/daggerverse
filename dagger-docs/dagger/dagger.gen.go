...
// The `GoogleCloudRunID` scalar type represents an identifier for an object of type GoogleCloudRun.
type GoogleCloudRunID string
...
// A unique identifier for this GoogleCloudRun.
func (r *GoogleCloudRun) ID(ctx context.Context) (GoogleCloudRunID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.q.Select("id")

	var response GoogleCloudRunID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *GoogleCloudRun) XXX_GraphQLType() string {
	return "GoogleCloudRun"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *GoogleCloudRun) XXX_GraphQLIDType() string {
	return "GoogleCloudRunID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *GoogleCloudRun) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *GoogleCloudRun) MarshalJSON() ([]byte, error) {
	id, err := r.ID(context.Background())
	if err != nil {
		return nil, err
	}
...
func (r *GoogleCloudRun) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
...
func (r *Client) GoogleCloudRun() *GoogleCloudRun {
	q := r.q.Select("googleCloudRun")
...
// Load a GoogleCloudRun from its ID.
func (r *Client) LoadGoogleCloudRunFromID(id GoogleCloudRunID) *GoogleCloudRun {
	q := r.q.Select("loadGoogleCloudRunFromID")
	q = q.Arg("id", id)
...
func (r *DaggerDocs) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
