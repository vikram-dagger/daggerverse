...
// example usage
// dagger -m github.com/vikram-dagger/daggerverse/dagger-docs call deploy --source . --project vikram-experiments --location us-central1 --repository vikram-test --credential env:GOOGLE_CREDENTIAL
