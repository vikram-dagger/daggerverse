...
func (r *Fileutils) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Fileutils":
		...
		case "ContainerEcho":
			...
			return (*Fileutils).ContainerEcho(&parent, stringArg), nil
		case "GrepDir":
			var parent Fileutils
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Fileutils).GrepDir(&parent, ctx, directoryArg, pattern)
		default:
	...
	case "":
		return dag.Module().
			WithObject(
				dag.TypeDef().WithObject("Fileutils").
					WithFunction(
